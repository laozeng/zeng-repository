...
<body>
	...
	<!--Struts2-->
	<%-- <h3 align="center">struts2登录</h3>
	<form action="<%=basePath%>user/doLogin.htm" method="post">
		<table style="margin:10px auto;" border="0">
		<tr>
			<td><span>用户名：</span></td>
			<td><input type="text" value="zengchang" name="user.username"/><br /></td>
		</tr>
		<tr>
			<td><span>密码：</span></td>
			<td><input type="password" value="123456" name="user.password"/><br /></td>
		</tr>
		<tr>
	...
	<form action="<%=basePath%>user/doLogin.mvc" method="post">
		<table style="margin:10px auto;" border="0">
		<tr>
			<td><span>用户名：</span></td>
